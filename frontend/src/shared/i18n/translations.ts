...
export const translations = {
  ...
  colValue: { az: "Bal", ru: "Балл", en: "Value" },
  addOption: { az: "Variant", ru: "Вариант", en: "Option" },
  numberOptions: { az: "1-dən nömrələ", ru: "Пронумеровать", en: "Number from 1" },
  clearNumbers: { az: "Balları sil", ru: "Убрать баллы", en: "Clear values" },
  numberedOptionsExplain: {
    az: "Bal verilən variantların ortalaması hesablanır. Bal yoxdursa yalnız sayılır.",
    ru: "Варианты с баллами усредняются.",
    en: "Numbered options can be averaged. Without numbers they are only counted.",
  },
  atLeastTwoOptions: { az: "Ǝn azı iki variant lazımdır", ru: "Нужно минимум два", en: "At least two options" },
  numberAllOptionsOrNone: {
    az: "Ya bütün variantlara bal verin, ya heç birinə",
    ru: "Проставьте баллы всем или ни одному",
    en: "Give every option a number, or none",
  },
  multipleChoice: { az: "Seçimli", ru: "С вариантами", en: "Multiple choice" },
  scoredChoice: { az: "Ballı seçim", ru: "С баллами", en: "Scored choice" },
  openQuestion: { az: "Açıq", ru: "Открытый", en: "Open" },
  headline: { az: "Ǝsas", ru: "Главный", en: "Headline" },
  useAsHeadline: {
    az: "Panelə əsas göstərici kimi çıxar",
    ru: "Показывать как главный",
    en: "Show as the headline metric",
  },
  headlineMustBeChoice: {
    az: "Yalnız ballı seçim sualı əsas ola bilər",
    ru: "Главным может быть только вопрос с баллами",
    en: "Only a scored multiple-choice question can be the headline",
  },
