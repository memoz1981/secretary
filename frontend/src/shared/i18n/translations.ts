...
export const translations = {
  ...
  needAQuestionnaireFirst: {
    az: "Əvvəlcə sualları olan bir sorğu yaradın.",
  ...
  atLeastTwoOptions: { az: "Ən azı iki variant lazımdır", ru: "Нужно минимум два", en: "At least two options" },
  ...
  coverage: { az: "Əhatə", ru: "Охват", en: "Coverage" },
  coverageExplain: {
  ...
  peopleReached: { az: "Əlaqə quruldu", ru: "Дозвонились", en: "Reached" },
